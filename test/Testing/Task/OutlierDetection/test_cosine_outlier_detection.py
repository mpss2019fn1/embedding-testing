...
class TestCosineOutlierDetection(BaseTestCase):
    ...
    def test_run_with_too_few_elements_in_group(self):
        task = CosineOutlierDetectionTask("Politicians",
    ...
    def test_run_disabled_returns_empty_result(self):
        ...
        test_configuration = TestConfiguration({}, {}, EntityLabels(), {}, [TaskConfiguration(TaskType.COSINE_OUTLIER_DETECTION, False)])
